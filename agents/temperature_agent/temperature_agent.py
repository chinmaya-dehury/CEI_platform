...
try:
    from agents.temperature_agent.temperature_registration import (
        metadata,
        register_with_controller,
        register_with_consul,
    )
    from agents.temperature_agent.temperature_requirements import get_requirements_data
    from agents.temperature_agent.temperature_intelligence import (
    ...
    from .temperature_registration import (
        metadata,
        register_with_controller,
        register_with_consul,
    )
    from .temperature_requirements import get_requirements_data
    from .temperature_intelligence import (
        generate_and_save_intelligence,
        append_synthetic_data,
    )
    from agents.shared.intelligence_upload_handler import IntelligenceUploadHandler
...
@app.route('/')
def index():
    return render_template('temperature_agent_index.html', endpoints_menu=ENDPOINTS_MENU, agent_title='Temperature Agent')
...
def intelligence():
    ...
    registry_path = "/app/agents/temperature_agent/created_intelligence.json"
...
def intelligence_by_id(intelligence_id):
    ...
    with open(
        "/app/agents/temperature_agent/created_intelligence.json",
        "r"
    ) as f:
        registry = json.load(f)
...
def list_uploaded_intelligences():
    ...
    intel_path = f"/app/agents/temperature_agent/intel_definitions"
    uploaded = []
...
def delete_uploaded_intelligence(filename):
    ...
    try:
        ...
        return jsonify({
            ...
            "next_steps": "Restart the temperature_intelligence_service to apply changes"
        }), 200

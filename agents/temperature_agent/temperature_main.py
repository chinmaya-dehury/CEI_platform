...
_DOCKER_FOLDER = "agents/temperature_agent/intel_definitions"
...
def load_created_intelligence_registry():
    ...
    for entry in registry:
        ...
        if result_path:
            if result_path.startswith("/app/agents/temperature_agent/"):
                abs_result = result_path
            elif result_path.startswith("agents/temperature_agent/"):

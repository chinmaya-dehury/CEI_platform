...
INTELLIGENCE_FOLDER = "agents.humidity_agent.intel_definitions"

_DOCKER_FOLDER = "agents/humidity_agent/intel_definitions"
...
def load_created_intelligence_registry():
    ...
    for entry in registry:
        ...
        if result_path:
            if result_path.startswith("/app/agents/humidity_agent/"):
                abs_result = result_path
            elif result_path.startswith("agents/humidity_agent/"):
...
def home():
    ...
    return jsonify({
        "message": "Humidity Intelligence Service Running"
    })
